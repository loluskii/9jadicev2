...
<template>
  <div class="container-fluid">
    <section class="row text-center justify-content-between fixed-bottom">
      <div
        class="col-lg-6 mx-auto col-sm-12 py-2"
          ...
          <div style="width: 20%" v-if="$auth.loggedIn" class="small">
            ...
            >
              <span class="position-relative">
                <!-- @if ($betNotifications > 0)
              <span
                class="badge badge-danger position-absolute"
                style="right: 0; margin-right: 20px"
              >
                {{ 1 }}
              </span>
              @endif -->
          ...
          <div style="width: 20%" v-if="$auth.loggedIn" class="small">
            ...
            >
              <div class="text-center">
                <img
                  src="/images/logos/logo-favicon.png"
                  style="height: 20px"
                />
              </div>
