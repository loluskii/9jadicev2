    ...
    <div class="row">
      <div class="col-12 p-0">
        <div class="d-flex flex-column small py-1 topic-bg">
          <div class="d-flex px-1">
            <div class="d-flex align-items-center">
              <div class="font-weight-bold text-capitalize">State Games</div>
            </div>
        ...
        <div id="verifiedGamesList">
          <div
              v-for="(game, index) in state_games"
              :key="index"
                ...
                >
                  ...
                  <span>
                    <button
                      ...
                      v-b-modal="'game_' + game.reference_id  + '_' + 10"
                    >
      ...
      <div class="col-12 p-0" id="verifiedGamesViewMore">
        <div v-if="state_games.length" class="text-center my-1">
          <a
...
export default {
  ...
  methods: {
    ...
    getStateGames() {
      this.loading = true;
      this.$axios.get("/tournaments?category=10&take=10").then((res) => {
        this.state_games = res.data.data;
        this.loading = false;
      });
    },
