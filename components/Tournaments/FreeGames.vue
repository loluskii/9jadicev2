    ...
    <div class="row">
      <div class="col-12 p-0">
        <div class="d-flex flex-column small py-1 topic-bg">
          <div class="d-flex px-1">
            <div class="d-flex align-items-center">
              <div class="font-weight-bold text-capitalize">Free Games</div>
            </div>
        ...
        <div id="verifiedGamesList">
          <div
              v-for="(game, index) in free_games"
              :key="index"
                ...
                >
                  ...
                  <span>
                    <button
                      ...
                      v-b-modal="'game_' + game.reference_id  + '_' + 12"
                    >
      ...
      <div class="col-12 p-0" id="verifiedGamesViewMore">
        <div v-if="free_games.length" class="text-center my-1">
          <a
