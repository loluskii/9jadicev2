    ...
    <div class="row">
      <div class="col-12 p-0">
        <div class="d-flex flex-column small py-1 topic-bg">
          <div class="d-flex px-1">
            <div class="d-flex align-items-center">
              <div class="font-weight-bold text-capitalize">Luxury Games</div>
            </div>
        ...
        <div id="verifiedGamesList">
          <div
              v-for="(game, index) in luxury_games"
              :key="index"
      ...
      <div class="col-12 p-0" id="verifiedGamesViewMore">
        <div v-if="luxury_games.length" class="text-center my-1">
          <a
...
export default {
  ...
  methods: {
    ...
    getLuxGames() {
      this.loading = true;
      this.$axios.get("/tournaments?category=7&take=10").then((res) => {
        this.luxury_games = res.data.data;
        this.loading = false;
      });
    },
