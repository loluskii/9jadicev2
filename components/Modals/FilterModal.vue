<template>
  <b-modal
    ...
    body-class="p-0 bg-black curvedEdge"
    id="filterModal"
  ...
  >
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          <form @submit.prevent="" class="mb-4 text-white">
            <input
              type="hidden"
              name="_token"
              value="Cp0ng4zE3Dse1JvW0xqrHan3uyBeiCvBOa9jQMol"
            />
            <div class="row mt-2">
              <div class="col-md-4 col-lg-4 col-xl-4 col-4">
                <label class="" for="term">
                  <input type="checkbox" name="latest" /> Latest
                </label>
              </div>
              <div class="col-md-4 col-lg-4 col-xl-4 col-4">
                <label class="" for="term">
              ...
              <div class="col-md-4 col-lg-4 col-xl-4 col-4">
                <label class="" for="term">
                  <input type="checkbox" name="ended" /> Ended
                </label>
              </div>
              <div class="col-md-4 col-lg-4 col-xl-4 col-4">
                <label class="" for="term">
            ...
            <button
              type="submit"
              class="btn btn-block bg-sv-primary text-sv-primary"
            >
              Apply
            </button>
          </form>
