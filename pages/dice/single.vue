                ...
                >
                  ...
                  <div class="py-2 mb-3">
                    <div style="font-size: 14px" class="text-white">
                      <div>
                        Play against the house. <br />Player with the highest
                        score after 5 throws each, wins.
                      </div>
                ...
                <div class="col-6 px-0">
                  <div id="die1container">
                    <img
                      id="die-1"
                      class="diceSize"
                      src="/images/gameplay/gameplay-assets/dices/1.png"
                    />
                  </div>
                </div>
                <div class="col-6 px-0">
                ...
                <div class="col-6 px-0">
                  <div id="die4container">
                    <img
                      id="die-4"
                      class="diceSize"
                      src="/images/gameplay/gameplay-assets/dices/4.png"
                    />
                  </div>
                </div>
              </div>
