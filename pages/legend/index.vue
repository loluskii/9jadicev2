<template>
  <div>
    <div class="row">
      ...
      >
        <img
          src="https://dice.ng/images/mobile/games/dice/gameplay-assets/arrow-up-anim.gif"
          class="img-fluid"
        />
      </div>
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  v-html="generatedTotalScore"
                ></div>
              </div>
              <div
                v-html="diceThrowInstruction"
        ...
        <div class="row justify-content-center" id="animated-cup-div">
          <div id="animated-cup" class="text-center">
            <a @click.prevent="playNormalGame">
              <img
                src="/images/gameplay/gameplay-assets/dice-cup-green.png"
                draggable="false"
                alt="dice-cup"
                id="animated-cup-img"
                class="mx-auto"
    ...
    <div class="d-flex flex-column align-items-center button-float-action-left">
      <button
        v-b-modal="'instructionModal_' + tournament.reference_id"
    ...
    <throw-limit-modal
      v-if="gameDataResponse"
      :tournament_id="tournament.id"
      :end_date="tournament.end_date"
      :tournament="tournament"
      :score="gameDataResponse.data.score"
    ></throw-limit-modal>
  </div>
</template>
  ...
  methods: {
    async playNormalGame() {
      if (this.count == 1) {
        ...
        setTimeout(() => this.showThrowLimitModal(), 2000);
      }
    },
    async turboMode() {
      this.isCupShaking = true;
