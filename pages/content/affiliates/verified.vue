  ...
  <div class="">
    <main class="container">
      <section class="container mb-5 mt-5">
          ...
          <div class="row text-dark align-items-center">
            ...
            >
              <ul class="text-decoration-none list-unstyled">
                ...
                <li class="text-muted list-unstyled text-left">
                  <span>
                    Verified Partners are offered the unique opportunity of
                    owning their own gaming business by partnering with the
                    first dice tournament platform in the world. Upon creating a
                    Verified tournament game between 2 – 5 million entries, and
                    the game gets full for example (Which is not a must), 90% of
                    the stake amount goes to the players and it's shared
                    according to the position in the leader-board, while 10%
                    goes to the company, which is shared between the company and
                    the Verified partner in a 70% for the company and 30% for
                    the Verified partner. As a partner, you will have access to
                    Dice.NG APP to track and monitor your tournament games.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <aside class="container bg-dark radius">
              ...
              <div class="row border-bottom border-top position-relative">
                ...
                >
                  ...
                  <div class="my-3 text-muted">
                    ...
                    <div class="">
                      Verified users join Dice.ng and markets the globally
                      trusted Dice.ng brand.
                    </div>
                  </div>
                </aside>
                ...
                >
                  ...
                  <div class="my-3 text-muted">
                    ...
                    <div class="">
                      The programme provides the Verified user with creative and
                ...
                >
                  ...
                  <div class="my-3 text-muted">
                    ...
                    <div class="">
                      The Verified user directs folks to play their tournament
                      games on Dice.ng.
                    </div>
                  </div>
                </aside>
                ...
                >
                  ...
                  <div class="my-3 text-muted">
                    ...
                    <div class="">
                      Our advanced tracking system allocates and pays the
                      Verified user their commission.
                    </div>
                  </div>
                </aside>
              </div>
        ...
        <aside class="bg-white container py-5 radiusInflected mt-5">
          <div class="row text-dark align-items-center">
            <div
              class="col-sm-12 col-md-6 col-lg-6 col-xl-6 wow slideInRight px-5"
              data-wow-delay="1s"
                ...
                >
                  <ol class="px-2 text-muted text-left list-unstyled">
                    ...
                    <div class="d-flex mt-2">
                      ...
                      <li class="lists pl-3 text-capitalize font-weight-light">
                        must have created a game of 10,000 players and the
                        tournament is full.
                      </li>
                    </div>
                    <div
                    ...
                    >
                      <li class="lists pl-3 text-capitalize text-center">or</li>
                    </div>
                    <div class="d-flex align-items-center mt-2">
                      <i class="fa fa-check"></i>
                      <li class="lists pl-3 text-capitalize font-weight-light">
                        must have deposited and played a game of up to 100,000
                        naira.
                      </li>
                    </div>
                  </ol>
...
.btnCol {
  animation: btnCol 2s ease-in infinite;
  box-shadow: 2px 3px 5px rgb(255, 255, 255);
}
.affiliate-img-height {
  width: 100%;
  height: 80vh;
}
...
.uniformShadow {
  box-shadow: 1px 2px 12px rgba(31, 30, 30, 0.329);
}
.numbers {
  ...
  border-radius: 50%;
  color: rgb(121, 57, 4);
  box-shadow: 2px 2px 5px 2px rgba(31, 30, 30, 0.383);
...
@keyframes btnCol {
  0% {
    color: rgb(213, 253, 223);
    background-color: rgb(4, 121, 38);
  }
  100% {
    color: rgb(172, 173, 172);
    background-color: rgb(4, 160, 48);
  }
}
