...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      {
        name: "description",
        content: "Win big with Nigeria's No.1 Dice gaming platform.",
      },
      {
        name: "keywords",
        content:
          "Diceng, tournament, dice tournament, dicecom, single dice, odd even, under over, mega ten, public games, private games, celebrity, verified, biggest prizes, luxury games, bonus games, free games, virtual, Nigeria, Virtual Betting, Sport, Odds, Live, Bonus, Free, Premier League, Premier, win, live betting, mobile, deposit, football, 9ja, betting website, livescore, predict",
      },
    ],
    link: [
